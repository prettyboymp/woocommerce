...
![Untagged docs appear at the top of the sidebar and category page, and tagged docs appear under with a heading](/img/doc_images/CleanShot-2024-01-15-at-14.01.16@2x.png)
