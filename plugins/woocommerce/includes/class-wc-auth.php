...
class WC_Auth {
	...
	protected function make_validation() {
		...
		foreach ( $params as $param ) {
			...
			$data[ $param ] = wp_unslash( $_REQUEST[ $param ] ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Recommended
		}
