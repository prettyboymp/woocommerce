...
<table class="wc_status_table widefat" cellspacing="0">
	...
	<tbody>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Information about the operating system your server is running.', 'woocommerce' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */ ?></td>
...
<table class="wc_status_table widefat" cellspacing="0">
	...
	<tbody>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Displays whether the current active theme is a block theme or a classic theme.', 'woocommerce' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */ ?></td>
			<td>
				<?php
