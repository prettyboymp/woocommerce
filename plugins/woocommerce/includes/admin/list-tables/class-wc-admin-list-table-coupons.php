...
class WC_Admin_List_Table_Coupons extends WC_Admin_List_Table {
	...
	protected function render_filters() {
		...
		<select name="coupon_type" id="dropdown_shop_coupon_type">
			...
			foreach ( $types as $name => $type ) {
				...
				if ( isset( $_GET['coupon_type'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Recommended
					selected( $name, wc_clean( wp_unslash( $_GET['coupon_type'] ) ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Recommended
				}
	...
	protected function query_filters( $query_vars ) {
		if ( ! empty( $_GET['coupon_type'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Recommended
